...
class lift_feet_right extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PoseDetectorViewState();
}

class _PoseDetectorViewState extends State<lift_feet_right> {
  ...
  String? _text;
  Detector_lift_feet_right Det = new Detector_lift_feet_right();//建立偵測系統
  @override
  void dispose() async {
    _canProcess = false;
    _poseDetector.close();
...
class Detector_lift_feet_right {
