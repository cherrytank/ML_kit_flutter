...
class thigh_abduction_right extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PoseDetectorViewState();
}

class _PoseDetectorViewState extends State<thigh_abduction_right> {
  ...
  String? _text;
  Detector_thigh_abduction_right Det = new Detector_thigh_abduction_right();//建立偵測系統
  @override
  void dispose() async {
    _canProcess = false;
    _poseDetector.close();
...
class Detector_thigh_abduction_right {
  ...
  void poseDetector() {
    ...
    if (this.startdDetector) {
      ...
      if (distance(posedata[50]!, posedata[51]!, posedata[52]!, posedata[53]!)>100 //膝蓋距離
        &&this.startdDetector) {
        //每秒目標
      ...
      //預防空值被訪問
      if (
      distance(posedata[50]!, posedata[51]!, posedata[52]!, posedata[53]!)<50 //膝蓋距離
      ) {
        //確認復歸
        this.startdDetector = true;
      } else {
