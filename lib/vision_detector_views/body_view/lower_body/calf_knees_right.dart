...
class calf_knees_right extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PoseDetectorViewState();
}

class _PoseDetectorViewState extends State<calf_knees_right> {
  ...
  String? _text;
  Detector_calf_knees_right Det = new Detector_calf_knees_right();//建立偵測系統
  @override
  void dispose() async {
    _canProcess = false;
    _poseDetector.close();
...
class Detector_calf_knees_right {
