...
class shoulder_raise_right extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _PoseDetectorViewState();
}

class _PoseDetectorViewState extends State<shoulder_raise_right> {
  ...
  String? _text;
  Detector_shoulder_raise_right Det = new Detector_shoulder_raise_right();//建立偵測系統
  @override
  void dispose() async {
    _canProcess = false;
    _poseDetector.close();
...
class Detector_shoulder_raise_right {
